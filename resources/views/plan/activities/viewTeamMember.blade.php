                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">{{$departments->name}}'s Organizational Unit Members List</h4>
                                            ...
                                            <tbody>
                                             ...
                                             <div class="avatar-xs">
                                                                            <span class="avatar-title rounded-circle bg-warning text-white font-size-16">
                                                                                {{ucfirst(Str::limit($member->name, 1,' '))}}{{ucfirst(Str::limit($member->last_name, 1,' '))}}
                                                                            </span>
                                                                        </div>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <div class="btn-group btn-group-example mb-1" role="group">

                                                             <a href="{{ route('daterange.teamleader',[Crypt::encrypt($member->id)]) }}"  class="btn btn-primary "><i class="mdi mdi-eye d-block font-size-10"></i></a>
