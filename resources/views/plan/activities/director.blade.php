...
@section('content')
       ...
       <button type="button" name="refresh" id="refresh" class="btn btn-warning btn-sm">Refresh</button>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Daily Activity</h4>
...
@include('plan.activities.color_count_team')
                        ...
                        <div class="row">
                            <div class="col-lg-8" name = 'cardinfo' id="cardinfo">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <img style="width: 50px" src="{{asset('storage/admins/'.$member->picture)}}" alt="" class="rounded-circle avatar-sm">

                                                    </td>
                                                    <td><a style="color:black" href="{{route('daterange.expertview',[$member->id, $did ])}}">{{$member->name}}</a></td>


                                                    {{-- <td>
                                                            <div>
                                                                <a href="{{route('daterange.expertview',[$member->id, $did ])}}" class="badge bg-primary bg-soft text-primary font-size-11">{{$member->email}}</a>
