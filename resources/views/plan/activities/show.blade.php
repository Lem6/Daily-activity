...
<div class="panel panel-default">
        ...
        <div class="pull-right">
            ...
            {{ csrf_field() }}
                <div class="btn-group btn-group-sm" role="group">
                    ...
                    <button type="submit" class="btn btn-danger" title="Delete Activity" onclick="return confirm(&quot;Click Ok to delete Activity.?&quot;)">
    ...
    <div class="panel-body">
        <dl class="dl-horizontal">
            ...
            <dd>{{ $activity->date }}</dd>
            <dt>Plan Task</dt>
            <dd>{{ optional($activity->planTask)->id }}</dd>
            <dt>User</dt>
            <dd>{{ optional($activity->user)->id }}</dd>
            <dt>Color</dt>
            <dd>{{ optional($activity->color)->planing_time }}</dd>
