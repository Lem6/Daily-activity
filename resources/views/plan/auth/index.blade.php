                            ...
                            <div class="w-100">
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5" style="margin-left:30%">
                                        <a href="https://techin.gov.et/" target="_blank" class="d-block auth-logo">
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div class="mt-4">
                                             <form method="POST" class="form-horizontal" action="{{ url('plan_login') }}">
                            @csrf
                <div class="mb-3">
                               ...
                               @enderror
                                ...
                                <div class="input-group auth-pass-inputgroup">
                                    ...
                                    @endif
                                      ...
                                      <p>© <script>document.write(new Date().getFullYear())</script> Techin<sup>2</sup>. All Rights Reserved </p>
                                            </div>
                                        </div>
                                    </div>
